				      ...
				      <div className="row">
				        <div className="col-xl-3 col-lg-6 col-md-5 offset-xl-2">
				          <div className="section-title mb-md-0">
				            <h2 className="title">Obten tu cupon</h2>
				            <p>Registrate y recibe toda informacion y tu CODIGO promocional.</p>
				          </div>
				        </div>
				        <div className="col-xl-4 col-lg-6 col-md-7 align-self-center offset-xl-1">
					          ...
					          <div className="input-group newslatter-wrap">
					            ...
					            <div className="input-group-append">
					             <input type="submit" className="btn btn-yellow vaijesubmit" value="Ok" />
					            </div>
					          </div>
				            </form>
				        </div>
